...
public class DateTimeUtils {
    ...
    public static long ONEWEEK_TIME = 24 * 60 * 60 * 7;// 一周的总秒数
    ...
    public static long currentTimeSecond() {
        //等同于 System.currentTimeMillis()/1000
    ...
    public static boolean isInTime(String bTime, String eTime) throws ParseException {
        ...
        boolean isInTime = DateTimeUtils.isWithin(beginTime, endTime);
        return isInTime;
    }
    ...
    public static boolean isInTime2(String bTime, String eTime) throws ParseException {
        ...
        Date beginTime = sdf1.parse(str + " " + bTime);
        Date endTime = sdf1.parse(str + " " + eTime);
        boolean isInTime = DateTimeUtils.isWithinDifferece2(beginTime, endTime);
        return isInTime;
    }
    ...
    public static Date getDateFromString(String date, String fmt) throws Exception {
        if (date == null || date.trim().length() == 0)
            return null;
        SimpleDateFormat sdf = fmt == null ? new SimpleDateFormat(DATE_FORMAT) : new SimpleDateFormat(fmt);
        return sdf.parse(date);
    }
